            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-16 lg:gap-24 mb-24">
                    ...
                    <div className="md:col-span-3">
                        <h4 className="text-xs font-bold uppercase tracking-[0.2em] mb-10 text-slate-500">{t('sections.how_it_works')}</h4>
                    ...
                    <div className="md:col-span-4">
                        <h4 className="text-xs font-bold uppercase tracking-[0.2em] mb-10 text-slate-500">{t('contact.info')}</h4>
                        <ul className="space-y-8">
                            <li className="flex flex-col gap-2">
                                <span className="text-slate-500 text-xs font-bold uppercase tracking-widest">{t('contact.address')}</span>
                                <span className="text-xl font-bold">{COMPANY_INFO.address[lang] || COMPANY_INFO.address.ar}</span>
                            </li>
                            <li className="flex flex-col gap-2">
                                <span className="text-slate-500 text-xs font-bold uppercase tracking-widest">{t('contact.email')}</span>
                                <span className="text-xl font-bold">{COMPANY_INFO.email}</span>
                            </li>
                            <li className="flex flex-col gap-2">
                                <span className="text-slate-500 text-xs font-bold uppercase tracking-widest">{t('contact.phone')}</span>
                ...
                <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-slate-500 text-sm font-semibold uppercase tracking-widest">
